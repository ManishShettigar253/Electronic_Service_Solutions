            ...
            <div class="card rounded-0 card-outline card-navy shadow" >
                <div class="card-body rounded-0">
                    ...
                    <form action="" id="message-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-sm form-control-border" id="fullname" name="fullname" pattern="[A-za-z ]{1,32}" required placeholder="Enter your name">
                            ...
                            <script>
                                ...
                                fullnameInput.addEventListener('blur', function () {
                                    const trimmedValue = fullnameInput.value.trim();
                                    fullnameInput.value = trimmedValue;
                                });

                            </script>
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-sm form-control-border" id="contact" name="contact" pattern="[0-9]{10}" required placeholder="Enter your contact">
                                <br>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="email" class="form-control form-control-sm form-control-border" id="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required placeholder="xxxxxx@xxxxxx.xxx">
                                 <br>
                            </div>
                        </div>
                        <script>
