        ...
        <div class="card-body">
            <div class="container-fluid">
                ...
                <div class="rounded-0 text-center mt-3">
                        ...
                        <button class="btn btn-success btn-flat btn-sm" onclick="Print();" type="button" id="delete_data"><i class="fa fa-print"></i> Print</button>
                        <a  class="btn btn-sm btn-danger btn-flat" href="https://mail.google.com/mail/u/0/#inbox?compose=new" target="_blank"   > <i class="fa fa-envelope"  ></i>  Mail</a>
...
/*
    ...
    {
        var url ="https://mail.google.com/mail/u/0/#inbox?compose=new";
        window.open(url,"Compose Mail","width=400,height=300");
    }
*/
    function Print() {
