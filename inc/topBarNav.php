        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a href="./?page=accessories" class="nav-link <?= isset($page) && $page =='accessories' ? "active" : "" ?>">ACCESSORIES</a>
              </li>
              <li class="nav-item">
                <a href="./?page=about" class="nav-link <?= isset($page) && $page =='about' ? "active" : "" ?>">ABOUT US</a>
              </li>              
              <li class="nav-item">
                <a href="./?page=faqs" class="nav-link <?= isset($page) && $page =='faqs' ? "active" : "" ?>">FAQ's</a>
              </li>
              ...
              <li class="nav-item" id="alignLogin">
              <a href="./admin/login.php" class="nav-link <?= isset($page) && $page =='profile' ? "active" : "" ?>">LOGIN</a>           
